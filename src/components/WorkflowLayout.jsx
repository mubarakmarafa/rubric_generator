  ...
  return (
    <div className="workflow-layout">
        ...
        <div className="sidebar-top">
          <div className="api-key-section">
            ...
            <button 
              ...
              className="set-api-key-btn"
            >
              Set API Key
            </button>
          </div>
          <div className={`image-upload-dropzone ${!isKeySet ? 'disabled' : ''}`}>
            Image Upload Drop Zone
          </div>
          <div className={`detected-question card${!isKeySet ? ' disabled' : ''}`}>Detected Question + Type</div>
        </div>
      ...
      <aside className="output-panel">
        <div className="generated-output">Generated Output / Rubric</div>
      </aside>
    </div>
  );
} 